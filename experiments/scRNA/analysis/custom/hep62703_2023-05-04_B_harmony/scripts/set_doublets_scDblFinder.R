...
scDatasetName <- "scDblFinder_cluster-dbr-custom-no-neg_2023-05-04.rds"

scDatasets <- readRDS(
    proot$find_file(config$outputpath, "data", scDatasetName)
)
...
analparams$doublet_data <- file.path(config$outputpath, "data", scDatasetName)
