...
scDatasets <- readRDS(
    proot$find_file(config$outputpath, "data", paste0("scDblFinder_cluster-dbr-custom-no-neg_2023-05-04.rds"))
)
...
cellsSelected <- rownames(SObj@meta.data)[
    (SObj$HTO_classification.global != "Negative") & SObj$keep_filters & SObj$keep_libs
]
